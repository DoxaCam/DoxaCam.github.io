...
const sqrtTwoMinOne = Math.sqrt(2) - 1;
    ...
    p.setup = () => {
        ...
        iterations.push(Box.getChildren(p, iterations[0], sqrtTwoMinOne));
        iterations.push(Box.getChildren(p, iterations[1], sqrtTwoMinOne));
        iterations.push(Box.getChildren(p, iterations[2], sqrtTwoMinOne));
